...
if($_SERVER['REQUEST_METHOD'] === "POST")
{
    ...
    try{
        $query = "DELETE FROM negozio_elettronica.prodotti WHERE codice = :id";
            ...
            <div class="card shadow-sm border-0 rounded-3">
                <div class="card-header bg-white border-bottom-0 pt-4 pb-0">
                    <h2 class="card-title fw-bold text-tech">
                        <i class="fas fa-box-open me-2"></i>Elimina Prodotto
                    </h2>
                    ...
                    <form method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="col-12 mt-4">
                            <button type="submit" class="btn btn-tech px-4 py-2">
                                <i class="fas fa-paper-plane me-2"></i>Elimina prodotto
                            </button>
                        </div>
                    </form>
                </div>
